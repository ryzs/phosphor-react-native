...
const AirplaneLanding = props => /*#__PURE__*/React.createElement(_reactNativeSvg.default, _extends({
  className: "airplane-landing-duotone__svg-icon-phosphor",
  fill: props.color,
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size
}, props), /*#__PURE__*/React.createElement(_reactNativeSvg.Path, {
  d: "M232 148.32V184L55.37 134.54A32 32 0 0 1 32 103.73V48a8 8 0 0 1 10.53-7.59L48 42.24l12 33.22L104 88V48a8 8 0 0 1 10.53-7.59l5.47 1.83 24 57.2 64.56 18A32 32 0 0 1 232 148.32Z",
  opacity: 0.2

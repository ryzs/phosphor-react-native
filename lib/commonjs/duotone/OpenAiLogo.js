...
const OpenAiLogo = props => /*#__PURE__*/React.createElement(_reactNativeSvg.default, _extends({
  className: "open-ai-logo-duotone__svg-icon-phosphor",
  fill: props.color,
  viewBox: "0 0 256 256",
  width: props.size,
  height: props.size
}, props), /*#__PURE__*/React.createElement(_reactNativeSvg.Path, {
  d: "m96 174.19 56-32.33v36.95l-44.5 25.69a48 48 0 0 1-66.4-64.08 48 48 0 0 0 10.4 8.08Zm108.5-66.69L160 81.81l-32 18.48 56 32.33V184a48 48 0 0 1-1.81 13 48 48 0 0 0 22.31-89.5ZM104 77.19l44.5-25.69a47.77 47.77 0 0 1 12.19-5A48 48 0 0 0 72 72v51.38l32 18.48Z",
  opacity: 0.2
